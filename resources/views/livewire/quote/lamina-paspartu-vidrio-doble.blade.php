<div>
    <div class="p-6 bg-white rounded-lg shadow-lg">
        <x-form-section submit="calcular">
            <x-slot name="title">
                {{ __('Cálculo de Cotización de Lámina con Paspartú y Vidrio Doble') }}
            </x-slot>
            
            <!-- Imagen pequeña debajo del título -->
            <div class="text-center my-4">
                <img src="{{ asset('admin/lamina-paspartu-vidrio-doble.png') }}" alt="Lámina con Paspartú y Vidrio Doble" class="mx-auto" style="max-width: 200px;">
            </div>
